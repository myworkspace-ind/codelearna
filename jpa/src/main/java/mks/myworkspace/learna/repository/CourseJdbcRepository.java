...
public class CourseJdbcRepository {
	...
	public Course save(Course course) {
		if (course.getId() == null) {
			...
			int rowsAffected = jdbcTemplate.update(sql, course.getName(), course.getOriginalPrice(),
					course.getDiscountedPrice(), course.getImageUrl(), course.getDescription(),
					course.getDifficultyLevel().getId(), course.getLessonType().getId(),
					course.getSubcategory().getId(), course.getIsFree() != null ? course.getIsFree() : false,
